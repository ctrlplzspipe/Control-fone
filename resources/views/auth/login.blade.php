...
@section('content')
    <!-- Contenedor Principal: Centrado en pantalla sobre fondo blanco puro -->
    <div class="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 lg:p-8 bg-white">

        <!-- Tarjeta Integrada Flotante (Split Screen tipo Card) -->
        <div
            class="w-full max-w-4xl bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 grid grid-cols-1 md:grid-cols-2">

            <!-- ================================================= -->
            <!-- COLUMNA IZQUIERDA: IMAGEN E INFORMACIÓN INSTITUCIONAL -->
            <!-- ================================================= -->
            <section
                class="relative hidden md:flex flex-col items-center justify-between bg-slate-50/80 p-8 xl:p-10 border-r border-gray-100">

                <!-- Decoración de fondo suave -->
                <div
                    class="absolute inset-0 opacity-15 bg-[radial-gradient(#9B2242_1px,transparent_1px)] [background-size:16px_16px]">
                </div>

                <!-- Header / Badge superior de la columna -->
                <div class="relative z-10 w-full flex justify-start">
                    <span
                        class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-[#9B2242]/10 text-[#9B2242]">
                        <span class="w-2 h-2 rounded-full bg-[#9B2242] animate-pulse"></span>
                        Sistema Institucional
                    </span>
                </div>

                <!-- Contenido Central / Logotipo Adaptable -->
                <div class="relative z-10 flex flex-col items-center text-center my-auto space-y-6 w-full max-w-xs">
                    <div
                        class="p-4 bg-white/90 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100/80 w-full flex items-center justify-center">
                        <img src="{{ asset('images/colibri.webp') }}" alt="Gobierno del Estado de México"
                            class="max-h-48 md:max-h-56 lg:max-h-64 w-auto object-contain transition-all duration-300">
                    </div>
            ...
            <section class="p-6 sm:p-10 xl:p-12 flex flex-col justify-between bg-white">
                ...
                <div>
                    ...
                    <div class="mb-8">
                        <div
                            class="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-[#9B2242]/10 text-[#9B2242] mb-4">
                    ...
                    <form method="POST" action="{{ route('login.post') }}" class="space-y-5">
                        ...
                        <div>
                            <label for="usuario"
                                class="block mb-1.5 text-xs font-bold text-gray-700 uppercase tracking-wider">
                                Usuario
                            </label>
                            <div class="relative">
                                <div
